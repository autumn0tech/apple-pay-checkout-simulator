      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {/* Cross-Device simulator */}
            {flowMode === "cross-device" && (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="px-5 pt-3 pb-4">
                <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2">Stripe — Online</p>
                <div className="space-y-1">
                  {[
                    {
              ...
              <div className="px-5 pt-1 pb-4">
                <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2">Stripe — In-Store / Terminal</p>
                <div className="space-y-1">
                  {[
                    {
                      label: "Wallets Overview (product support table)",
                      url: "https://docs.stripe.com/payments/wallets",
                      desc: "Which wallets work with Terminal, Subscriptions, and more — including Apple Pay",
                    },
                    {
                      label: "Stripe Terminal — Accept In-Person Payments",
                      url: "https://docs.stripe.com/terminal/overview",
                      desc: "Terminal SDK quickstart: readers, connection tokens, and PaymentIntents",
                    },
                    {
                      label: "Collect Card Payments (Terminal JS SDK)",
                      url: "https://docs.stripe.com/terminal/payments/collect-card-payment",
                      desc: "collectPaymentMethod → confirmPaymentIntent flow with card_present",
                    },
                    {
                      label: "Save Payment Details After Payment",
                      url: "https://docs.stripe.com/terminal/features/saving-payment-details/save-after-payment",
                      desc: "setup_future_usage: 'off_session' on a card_present PaymentIntent",
                    },
                  ].map((link) => (
                    <a
                      key={link.url}
